...
type ConfiguredStream struct {
	...
	CalibrationId           uint64              `binding:"excluded_unless=StreamType 1 StreamType 2" gorm:"column:calibration_id" json:"CalibrationId"`
	...
	ObservedRelatedStreamId *uint64             `binding:"excluded_unless=StreamType 1 StreamType 2" json:"ObservedRelatedStreamId"`
}
